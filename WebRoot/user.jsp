				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="user/changPwd.jsp" target="myiframe"> <i
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li><a class="dropdown-toggle"> <i class="icon-edit"></i>
							<span class="menu-text"> 用车申请 </span> <b
							class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							<li><a href="user/selectVehicle.jsp" target="myiframe"> <i
									class="icon-double-angle-right"></i> 查看车辆信息
							</a></li>

							<li><a href="user/selectApplication.jsp" target="myiframe"> <i
									class="icon-double-angle-right"></i> 查看所有申请
							</a></li>
							<li><a href="returnCar" target="myiframe"> <i
									class="icon-double-angle-right"></i> 归还车辆
							</a></li>
